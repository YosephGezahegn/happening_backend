...
router.route('/device/api/v1/comment/aggregate').post(auth(...[ 'aggregateByUserInDevicePlatform' ]),checkRolePermission,CommentController.getCommentByAggregate);
...
router.route('/device/api/v1/comment/:id').post(auth(...[ 'getByUserInDevicePlatform' ]),checkRolePermission,CommentController.getComment);
