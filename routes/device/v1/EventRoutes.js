...
router.route('/device/api/v1/event/aggregate').post(auth(...[ 'aggregateByUserInDevicePlatform' ]),checkRolePermission,EventController.getEventByAggregate);
...
router.route('/device/api/v1/event/:id').post(auth(...[ 'getByUserInDevicePlatform' ]),checkRolePermission,EventController.getEvent);
