...
router.route('/admin/comment/aggregate').post(auth(...[ 'aggregateByAdminInAdminPlatform' ]),checkRolePermission,CommentController.getCommentByAggregate);
...
router.route('/admin/comment/:id').post(auth(...[ 'getByAdminInAdminPlatform' ]),checkRolePermission,CommentController.getComment);
