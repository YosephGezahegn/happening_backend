...
router.route('/admin/event/aggregate').post(auth(...[ 'aggregateByAdminInAdminPlatform' ]),checkRolePermission,EventController.getEventByAggregate);
...
router.route('/admin/event/:id').post(auth(...[ 'getByAdminInAdminPlatform' ]),checkRolePermission,EventController.getEvent);
