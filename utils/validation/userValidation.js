...
exports.schemaKeys = joi.object({
  ...
  admin: joi.boolean(),
  savedEvents: joi.array().items(joi.object()),
...
exports.findFilterKeys = joi.object({
  ...
  ...Object.fromEntries(
    keys.map(key => [key, joi.object({
      ...
      organizer: joi.alternatives().try(joi.array().items(),joi.boolean(),joi.object()),
      admin: joi.alternatives().try(joi.array().items(),joi.boolean(),joi.object()),
